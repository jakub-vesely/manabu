...
#include "../../../../manabu/program/manabu/ModuleWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModuleWidget_t, stringdata) + ofs \
...
const QMetaObject ModuleWidget::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_ModuleWidget.data,
...
void *ModuleWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModuleWidget.stringdata))
